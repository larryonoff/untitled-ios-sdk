...
extension Version: LosslessStringConvertible {
  ...
  public init?(_ versionString: String) {
    ...
    var versionCoreIdentifiers = versionCore.split(separator: ".", omittingEmptySubsequences: false)

    if versionCoreIdentifiers.count < 3 {
      versionCoreIdentifiers += Array(repeating: "0", count: 3 - versionCoreIdentifiers.count)
    }
